...
Es muy difícil trabajar con la información en la forma en la que está dispuesta. Entonces, vamos a implementar diferentes filtros sobre los datos para poder consultar solo aquellos qué:
...
Ahora, queremos dado un docente y un año, poder consultar:
...
500 * ipc(Enero 2020) / ipc(Marzo 2026)
...
Ahora queremos, dado un sueldo de un docente en un determinado período (año + mes), ajustarlo por ipc a cada período (año + mes) del 2026.

Lo siguiente es hacer una comparativa: dado un período para tomar de referencia, un docente y un período destino, queremos saber qué tan por abajo o por arriba está su sueldo real de su sueldo ajustado por ipc.
...
Usar esas 2 funciones para comparar los valores de los salario mes a mes de un docente en 2026 contra los valores ajustados tomando como referencia alguna fecha en el pasado.
...
Finalmente, queremos hacer una consulta más:
